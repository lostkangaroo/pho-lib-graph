...
class Edge implements
   ...
   * @param ?NodeInterface $head The node where this edge is targeted at.
   *   Default: null.
   * @param ?PredicateInterface $predicate The predicate of this edge. Default:
   *   null.
   *
   * @throws Exceptions\DuplicateEdgeException when it's not a multiplicable
   *   edge and there's an attempt to create multiple edges between a
   *   particular pair of head and tail nodes.
   */
   ...
   *
   * The predicate may be given. Or it may be resolved by the name of this
   * class. Or it may be given a fallback. As a last resort, it may use the
   * Predicate class available in pho-lib-graph.
   *
   * @param PredicateInterface|null $predicate Predicate may be given.
   * @param string $fallback or the fallback class may be given, asking the
   *   method find something more specific if available.
   *
